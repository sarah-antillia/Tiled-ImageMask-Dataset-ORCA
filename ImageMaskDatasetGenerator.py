...
class ImageMaskDatasetGenerator:
  ...
  def __init__(self, width=512*10, height=512*10, input_dir="./valid/",
               output_dir="./ORCA_master/", augmentation=True):
    self.W          = width
    self.H          = height
...
if __name__ == "__main__":
  ...
  try:
    # This generate the following master datgaset withot augmentation
    #   ./ORCA_master
    #      +-- images 
    #      +-- masks 
    # 1 Read all images and mask files in the orignal valid   
    # 2 Resize all images and masks to 512*10 > 4500(original).
    # 3 Save all images to ORCA_master/images as jpg files to save disk space.
    # 4 Save all masks to ORCA_master/masks as jpg files to save disk space.

    # The number of image files and mask files becomes 100 repectively.
    ...
    RESIZE = 512*10
    generator = ImageMaskDatasetGenerator(width=RESIZE, height=RESIZE, 
                                          input_dir=input_dir,
